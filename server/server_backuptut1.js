...
const client = new OpenAIClient(
  "https://openaiexplorasius.openai.azure.com/", 
  new AzureKeyCredential("ff538b2720be4177b30e099172951d97")
);
const { id, created, choices, usage } = await client.getCompletions("gpt-5-turbo", ["tell me a joke please"]);
